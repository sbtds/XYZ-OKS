        ...
        <div class="common_footer__container container-base">
          <div class="common_footer__main">
            <p class="common_footer__id">
              <a href="<?php echo home_url(); ?>">
                <img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/common_id.png"
                  alt="<?php bloginfo('name'); ?>" class="default">
              </a>
            </p>
            ...
            <ul class="common_footer__sns">
              <li>
                <a href="http://facebook.com/oks.miyagi.kanagawa" target="_blank"><img
                    src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/common_sns01.png" alt=""></a>
              </li>
              <li>
                <a href="https://www.instagram.com/oks.miyagi.kanagawa/" target="_blank"><img
                    src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/common_sns02.png"
                    alt="Instagram"></a>
              </li>
              <li>
                <a href="https://lin.ee/jSxJC4Z" target="_blank"><img
                    src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/common_sns03.png"
                    alt="LINE登録"></a>
              </li>
              <li>
                <a href="https://www.youtube.com/@oksjpn" target="_blank"><img
                    src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/common_sns04.png"
                    alt="Youtube"></a>
              </li>
            </ul>
          </div>
