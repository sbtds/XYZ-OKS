                ...
                <div class="search_main__panel_item" id="search_main_type">
                  ...
                  <div class="search_main__panel_block">
                    ...
                    foreach ($job_type_groups as $index => $group):
                        $group_index = $index + 1;
                        $type_id = sprintf('search_main__type%02d', $group_index);
...
jQuery(document).ready(function($) {
  ...
  // メインフォームの職種チェックボックスのイベントハンドラー（新しい構造に対応）
  $('#search_main_type').on('change', '.search_select__area_check', function() {
    var $this = $(this);
  ...
  // Individual sub-item checkbox handling for main type
  $('#search_main_type').on('change', '.search_select__area_item_check', function() {
    var $container = $(this).closest('.search_select__area');
